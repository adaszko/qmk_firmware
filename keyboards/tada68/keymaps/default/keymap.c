...
OSM(MOD_LSFT),  KC_Z,       KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,   KC_COMM,    KC_DOT,         OSM(MOD_RALT),    KC_RSHIFT,              KC_UP,    KC_PGDN, \
...
_______, BL_DEC,    KC_VOLD,    BL_INC,     _______,    _______,    KC_LEFT,    KC_DOWN,    KC_UP,      KC_RGHT,    _______,    _______,    _______,    KC_HOME, \
_______, _______,   _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    KC_SLSH,    _______,    KC_PGUP,    KC_END, \
