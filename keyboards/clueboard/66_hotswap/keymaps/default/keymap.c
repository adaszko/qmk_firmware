...
[_BL] = LAYOUT(
  ...
  MO(_FL),KC_LALT,KC_LGUI,                KC_HYPR, KC_SPC,                         _______,KC_RALT,KC_HYPR, MO(_CL),KC_LEFT,KC_DOWN,KC_RGHT),
...
[_CL] = LAYOUT(
  ...
  _______,_______,_______,                _______,KC_MPLY,                        _______,_______,_______,_______,KC_MRWD,KC_VOLD,KC_MFFD),
};
